...
<body class="h-full">
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            <h1 class="text-center text-2xl font-bold text-red-600 sm:text-3xl">Buat Akun</h1>
            ...
            <form action="#" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" class="w-full rounded-lg border-red-200 p-4 pe-12 text-sm shadow-sm"
                            placeholder="Nama" />
